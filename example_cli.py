...
if __name__ == "__main__":
    ...
    appClientId = "14055_07onrT9CnvWSREGzapOBRPKx4XPFRidnAzlEpLWg8kTn66xiNZ"
    appClientSecret = "HNhw47uaPLtqCgSvRTrX6JwXJCrBX6RSPsrw8cXc7y8RYBR2Mt"
    ...
    if isTokenAvailable == False:
        ...
        accessToken = "7PO-_QEolEpX_4kaIZQTb6UqeQ_JiRcQd_qFjW13GVU"
    ...
    def onMessageReceived(client, message): # Callback for receiving all messages
        print(f"[debug] Incoming payloadType = {message.payloadType}")
    ...
    # Wrap .send() with debug print
    # original_send = client.send

    # def debug_send(request, *args, **kwargs):
    #     print(f"[debug] Sending payloadType={request.payloadType}")
    #     print("[debug] Payload as JSON:")
    #     print(json.dumps(MessageToDict(request), indent=2))
    #     return original_send(request, *args, **kwargs)
    
    # client.send = debug_send
